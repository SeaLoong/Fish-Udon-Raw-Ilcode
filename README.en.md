...
├── 02-28/                       # Feb 28 decompilation snapshot
│   └── autogenerated/           #   174 decompiled programs
└── 03-01/                       # Mar 1 decompilation snapshot
    └── autogenerated/           #   174 decompiled programs (identical IL)
```

> **Note**: Both snapshots contain identical IL content across all 174 programs. Only timing statistics differ.
